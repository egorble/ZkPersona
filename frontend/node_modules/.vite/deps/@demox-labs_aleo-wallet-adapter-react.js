...
import "./eventemitter3-DJwqmRen.js";
import { t as require_dist$1 } from "./dist-D0NPRaTx.js";

//#region node_modules/@demox-labs/aleo-wallet-adapter-react/dist/useLocalStorage.js
var require_useLocalStorage = /* @__PURE__ */ __commonJS({ "node_modules/@demox-labs/aleo-wallet-adapter-react/dist/useLocalStorage.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.useLocalStorage = void 0;
	var react_1$2 = require_react();
	function useLocalStorage(key, defaultState) {
		const state = (0, react_1$2.useState)(() => {
			try {
...
//#endregion
//#region node_modules/@demox-labs/aleo-wallet-adapter-react/dist/useWallet.js
var require_useWallet = /* @__PURE__ */ __commonJS({ "node_modules/@demox-labs/aleo-wallet-adapter-react/dist/useWallet.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	exports.WalletContext = (0, react_1$1.createContext)(DEFAULT_CONTEXT);
	function useWallet() {
		return (0, react_1$1.useContext)(exports.WalletContext);
	}
	exports.useWallet = useWallet;
}) });

//#endregion
//#region node_modules/@demox-labs/aleo-wallet-adapter-react/dist/WalletProvider.js
var require_WalletProvider = /* @__PURE__ */ __commonJS({ "node_modules/@demox-labs/aleo-wallet-adapter-react/dist/WalletProvider.js": ((exports) => {
	...
	var aleo_wallet_adapter_base_1 = require_dist$1();
	...
	var WalletProvider = ({ children, wallets: adapters, autoConnect = false, decryptPermission = aleo_wallet_adapter_base_1.DecryptPermission.NoDecrypt, network = aleo_wallet_adapter_base_1.WalletAdapterNetwork.TestnetBeta, onError, localStorageKey = "walletName", programs = [] }) => {
		...
		const [wallets, setWallets] = (0, react_1.useState)(() => adapters.map((adapter$1) => ({
			adapter: adapter$1,
			readyState: adapter$1.readyState
		})));
		(0, react_1.useEffect)(() => {
			setWallets((wallets$1) => adapters.map((adapter$1, index) => {
				const wallet$1 = wallets$1[index];
				return wallet$1 && wallet$1.adapter === adapter$1 && wallet$1.readyState === adapter$1.readyState ? wallet$1 : {
					adapter: adapter$1,
					readyState: adapter$1.readyState
				};
			}));
			function handleReadyStateChange(readyState$1) {
			...
			return () => adapters.forEach((adapter$1) => adapter$1.off("readyStateChange", handleReadyStateChange, adapter$1));
		}, [adapters]);
		(0, react_1.useEffect)(() => {
			const wallet$1 = name && wallets.find(({ adapter: adapter$1 }) => adapter$1.name === name);
			if (wallet$1) setState({
				wallet: wallet$1,
				adapter: wallet$1.adapter,
				connected: wallet$1.adapter.connected,
				publicKey: wallet$1.adapter.publicKey
			});
		...
		(0, react_1.useEffect)(() => {
			if (isConnecting.current || connected || !autoConnect || !adapter || !(readyState === aleo_wallet_adapter_base_1.WalletReadyState.Installed || readyState === aleo_wallet_adapter_base_1.WalletReadyState.Loadable)) return;
			(async function() {
		...
		const connect = (0, react_1.useCallback)(async () => {
			...
			if (!adapter) throw handleError(new aleo_wallet_adapter_base_1.WalletNotSelectedError());
			if (!(readyState === aleo_wallet_adapter_base_1.WalletReadyState.Installed || readyState === aleo_wallet_adapter_base_1.WalletReadyState.Loadable)) {
				setName(null);
				if (typeof window !== "undefined") window.open(adapter.url, "_blank");
		...
		const signMessage = (0, react_1.useMemo)(() => adapter && "signMessage" in adapter ? async (message) => {
			if (!connected) throw handleError(new aleo_wallet_adapter_base_1.WalletNotConnectedError());
...
//#endregion
//#region node_modules/@demox-labs/aleo-wallet-adapter-react/dist/index.js
var require_dist = /* @__PURE__ */ __commonJS({ "node_modules/@demox-labs/aleo-wallet-adapter-react/dist/index.js": ((exports) => {
